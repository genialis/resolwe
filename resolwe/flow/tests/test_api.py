...
class TestDataViewSetCase(TestCase):
    ...
    def test_duplicate(self):
        ...
        # Handler is called when bulk_copy signal is triggered.
        handler = MagicMock()
        bulk_copy.connect(handler, sender=Data)
        ...
        handler.assert_called_once_with(
            signal=bulk_copy, instances=[duplicate], sender=Data
        )
        handler.reset_mock()
...
class TestCollectionViewSetCase(TestCase):
    ...
    def test_duplicate(self):
        # Handler is called when bulk_copy signal is triggered.
        handler = MagicMock()
        bulk_copy.connect(handler, sender=Collection)
        ...
        self.assertTrue(duplicate.is_duplicate())
        handler.assert_called_once_with(
            signal=bulk_copy, instances=[duplicate], sender=Collection
        )
...
class EntityViewSetTest(TestCase):
    ...
    def test_duplicate(self):
        ...
        handler = MagicMock()
        bulk_copy.connect(handler, sender=Entity)
        ...
        handler.assert_called_once_with(
            signal=bulk_copy, instances=[duplicate], sender=Entity
        )
        handler.reset_mock()
