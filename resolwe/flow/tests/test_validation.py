...
class ValidationTest(TestCase):
    ...
    def test_validate_data_descriptor(self):
        ...
        with self.assertRaisesRegex(ValidationError, "is not valid under any of the given schemas"):
            data.save()
...
class ValidationUnitTest(TestCase):
    ...
    def test_file_field(self):
        ...
        with self.assertRaisesRegex(ValidationError, "'ftp' is not of type 'boolean'"):
            validate_schema(instance, schema)
