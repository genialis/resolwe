...
class UserGroupTestCase(TestCase):
    def setUp(self):
        ...
        collection2.set_permission("view", self.contributor)
        collection2.set_permission("view", self.group1)
    ...
    def test_user(self):
        ...
        self.assertCountEqual(user_perms, ["view", "edit"])

    def test_user_in_group(self):
        self.group1.user_set.add(self.contributor)
        self.collection.set_permission("edit", self.group1)

        user_perms, group_perms = get_user_group_perms(
            self.contributor, self.collection
        )
        self.assertEqual(len(group_perms), 1)
        self.assertCountEqual(group_perms[0][2], ["view", "edit"])
        ...
        self.assertCountEqual(user_perms, ["view"])

    def test_user_in_multiple_groups(self):
        self.group1.user_set.add(self.contributor)
        self.group2.user_set.add(self.contributor)
        self.collection.set_permission("edit", self.group1)
        self.collection.set_permission("view", self.group2)
        ...
        self.assertCountEqual(group_perms[1][2], ["view"])
        self.assertEqual(len(user_perms), 0)
...
class ObjectPermsTestCase(TestCase):
    ...
    def test_all_permissions(self):
        ...
        self.collection.set_permission("edit", self.user1)
        self.collection.set_permission("view", self.user2)
        expected_perms = [
            {
        ...
        self.collection.set_permission("view", self.anonymous)
